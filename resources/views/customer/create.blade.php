        ...
        <div class="card mb-4 px-4">
            ...
            <form action="{{ route('customer.store') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    placeholder="Kamal Udin" value="{{ old('customer_name') }}">
                    @error('customer_name')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="ordered" class="form-control @error('ordered') is-invalid @enderror" id="ordered" value="{{ old('ordered') }}">
                    @error('ordered')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
